...
export default function About() {
  return (
    <div>
      {/* ═══════════ HERO ═══════════ */}
      <section className="mx-auto grid max-w-7xl items-center gap-8 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-2 lg:px-8 lg:py-20">
        <div>
          ...
          <h1 className="mt-6 text-3xl font-extrabold leading-tight text-slate-900 sm:text-4xl md:text-5xl lg:text-6xl">
      ...
      {/* ══════════ OUR STORY ═══════════ */}
      <section className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-2 lg:px-8 lg:py-20">
        ...
        <div>
          ...
          <div className="mt-6 space-y-4 text-base text-gray-600 sm:text-lg">
            <p>
      ...
      <section className="mx-auto my-8 max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[28px] bg-[#edeafb] p-6 sm:p-8 md:px-10 md:py-10 lg:flex lg:items-center lg:justify-between lg:gap-12 lg:pr-10">
          <div className="lg:max-w-xl">
            <h2 className="text-lg font-semibold text-gray-900">Our Philosophy</h2>
            <div className="mt-2 h-0.5 w-9 rounded bg-gray-600" />
            <h3 className="mt-5 text-2xl font-extrabold text-gray-900 sm:text-3xl md:text-4xl">Storytelling is our superpower.</h3>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600 sm:text-base">Meet the minds behind the magic:</p>
        </div>
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="mb-12">
            <h2 className="text-2xl font-extrabold text-[#0F172A] sm:text-3xl md:text-4xl lg:text-[40px]">
              Why choose{" "}
